...
export const translations: Record<Language, any> = {
    en: {
        ...
        shareIp: 'Or tell them to visit:', copy: 'Copy', shared: 'Shared', copied: 'Copied',
    ...
    sk: {
        ...
        shareIp: 'Alebo im povedzte, aby navštívili:', copy: 'Kopírovať', shared: 'Zdieľané', copied: 'Skopírované',
    ...
    ru: {
        ...
        shareIp: 'Или скажите им перейти по адресу:', copy: 'Копировать', shared: 'Поделиться', copied: 'Скопировано',
    ...
    uk: {
        ...
        shareIp: 'Або скажіть їм перейти за адресою:', copy: 'Копіювати', shared: 'Поділитися', copied: 'Скопійовано',
