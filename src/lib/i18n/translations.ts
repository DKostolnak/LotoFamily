...
export const translations: Record<Language, TranslationKeys> = {
    en: {
        ...
        reportReasonName: 'Inappropriate name',
        reportReasonAvatar: 'Inappropriate avatar',
        reportReasonChat: 'Inappropriate message',
        ...
        cardLabel: 'Card',
        questPlayGames: 'Play {n} games',
        questPlayGamesDesc: 'Any mode counts',
        questMarkNumbers: 'Mark {n} numbers',
        questMarkNumbersDesc: 'Tap called numbers on your cards',
        questWinGame: 'Win a game',
        questWinGameDesc: 'Be the first to complete a card',
        questUsePowerUp: 'Use a power-up',
        questUsePowerUpDesc: 'Peek, Lucky Mark or Slow Time',
        doubleBonusCta: 'Double it: +{n}',
        shopCoinsTab: 'Coins',
        iapRemoveAdsTitle: 'Remove Ads',
        iapRemoveAdsDesc: 'No more interstitial ads. Forever.',
        iapBestValue: 'BEST VALUE',
        iapRestorePurchases: 'Restore Purchases',
        iapRestoreSuccess: 'Purchases restored!',
        iapRestoreNone: 'No purchases to restore',
        iapPurchaseSuccess: 'Thank you for your purchase!',
        iapPurchaseFailed: 'Purchase failed. Please try again.',
        iapUnavailable: 'Store is not available right now. Try again later.',
        iapCoinsGranted: '+{amount} coins!',
    ...
    sk: {
        ...
        reportPlayer: 'Nahlásiť hráča',
        blockPlayer: 'Zablokovať hráča',
        unblockPlayer: 'Odblokovať',
        blockedPlayers: 'Zablokovaní hráči',
        reportReasonName: 'Nevhodné meno',
        reportReasonAvatar: 'Nevhodný avatar',
        reportReasonChat: 'Nevhodná správa',
        reportReasonOther: 'Iné',
        reportThanks: 'Ďakujeme, preveríme to',
        blockedEmpty: 'Nikto nie je zablokovaný',
        ...
        cardLabel: 'Karta',
        questPlayGames: 'Zahraj {n} hry',
        questPlayGamesDesc: 'Počíta sa každý režim',
        questMarkNumbers: 'Označ {n} čísel',
        questMarkNumbersDesc: 'Klepni na volané čísla na svojich kartách',
        questWinGame: 'Vyhraj hru',
        questWinGameDesc: 'Dokonči kartu ako prvý',
        questUsePowerUp: 'Použi power-up',
        questUsePowerUpDesc: 'Peek, Lucky Mark alebo Slow Time',
        doubleBonusCta: 'Zdvojnásob: +{n}',
        shopCoinsTab: 'Mince',
        iapRemoveAdsTitle: 'Odstrániť reklamy',
        iapRemoveAdsDesc: 'Už žiadne vyskakovacie reklamy. Navždy.',
        iapBestValue: 'NAJVÝHODNEJŠIE',
        iapRestorePurchases: 'Obnoviť nákupy',
        iapRestoreSuccess: 'Nákupy obnovené!',
        iapRestoreNone: 'Žiadne nákupy na obnovenie',
        iapPurchaseSuccess: 'Ďakujeme za nákup!',
        iapPurchaseFailed: 'Nákup zlyhal. Skús to znova.',
        iapUnavailable: 'Obchod momentálne nie je dostupný. Skús neskôr.',
        iapCoinsGranted: '+{amount} mincí!',
    ...
    ru: {
        ...
        reportPlayer: 'Пожаловаться на игрока',
        blockPlayer: 'Заблокировать игрока',
        unblockPlayer: 'Разблокировать',
        blockedPlayers: 'Заблокированные игроки',
        reportReasonName: 'Неподходящее имя',
        reportReasonAvatar: 'Неподходящий аватар',
        reportReasonChat: 'Неподходящее сообщение',
        reportReasonOther: 'Другое',
        reportThanks: 'Спасибо, мы проверим',
        blockedEmpty: 'Никто не заблокирован',
        ...
        cardLabel: 'Карта',
        questPlayGames: 'Сыграйте {n} игры',
        questPlayGamesDesc: 'Любой режим считается',
        questMarkNumbers: 'Отметьте {n} чисел',
        questMarkNumbersDesc: 'Нажимайте на выпавшие числа на картах',
        questWinGame: 'Выиграйте игру',
        questWinGameDesc: 'Первым заполните карту',
        questUsePowerUp: 'Используйте усиление',
        questUsePowerUpDesc: 'Подсказка, Счастливая метка или Замедление',
        doubleBonusCta: 'Удвоить: +{n}',
        shopCoinsTab: 'Монеты',
        iapRemoveAdsTitle: 'Убрать рекламу',
        iapRemoveAdsDesc: 'Больше никакой рекламы. Навсегда.',
        iapBestValue: 'ВЫГОДНО',
        iapRestorePurchases: 'Восстановить покупки',
        iapRestoreSuccess: 'Покупки восстановлены!',
        iapRestoreNone: 'Нет покупок для восстановления',
        iapPurchaseSuccess: 'Спасибо за покупку!',
        iapPurchaseFailed: 'Покупка не удалась. Попробуйте ещё раз.',
        iapUnavailable: 'Магазин сейчас недоступен. Попробуйте позже.',
        iapCoinsGranted: '+{amount} монет!',
    ...
    uk: {
        ...
        reportPlayer: 'Поскаржитися на гравця',
        blockPlayer: 'Заблокувати гравця',
        unblockPlayer: 'Розблокувати',
        blockedPlayers: 'Заблоковані гравці',
        reportReasonName: 'Неприйнятне імʼя',
        reportReasonAvatar: 'Неприйнятний аватар',
        reportReasonChat: 'Неприйнятне повідомлення',
        reportReasonOther: 'Інше',
        reportThanks: 'Дякуємо, ми перевіримо',
        blockedEmpty: 'Нікого не заблоковано',
        ...
        cardLabel: 'Картка',
        questPlayGames: 'Зіграйте {n} ігри',
        questPlayGamesDesc: 'Будь-який режим враховується',
        questMarkNumbers: 'Позначте {n} чисел',
        questMarkNumbersDesc: 'Натискайте на випалі числа на картках',
        questWinGame: 'Виграйте гру',
        questWinGameDesc: 'Першим заповніть картку',
        questUsePowerUp: 'Використайте підсилення',
        questUsePowerUpDesc: 'Підказка, Щаслива мітка або Сповільнення',
        doubleBonusCta: 'Подвоїти: +{n}',
        shopCoinsTab: 'Монети',
        iapRemoveAdsTitle: 'Прибрати рекламу',
        iapRemoveAdsDesc: 'Більше жодної реклами. Назавжди.',
        iapBestValue: 'ВИГІДНО',
        iapRestorePurchases: 'Відновити покупки',
        iapRestoreSuccess: 'Покупки відновлено!',
        iapRestoreNone: 'Немає покупок для відновлення',
        iapPurchaseSuccess: 'Дякуємо за покупку!',
        iapPurchaseFailed: 'Покупка не вдалася. Спробуйте ще раз.',
        iapUnavailable: 'Магазин зараз недоступний. Спробуйте пізніше.',
        iapCoinsGranted: '+{amount} монет!',
